 ...
 * generated in the com.ups.tracking.trackrequest package.
...
public class ObjectFactory {
    ...
    private final static QName _Request_QNAME = new QName("http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", "Request");
    private final static QName _Response_QNAME = new QName("http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", "Response");
    private final static QName _ClientInformation_QNAME = new QName("http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", "ClientInformation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ups.tracking.trackrequest
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", name = "Request")
     ...
     */
    @XmlElementDecl(namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", name = "Response")
     ...
     */
    @XmlElementDecl(namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", name = "ClientInformation")
