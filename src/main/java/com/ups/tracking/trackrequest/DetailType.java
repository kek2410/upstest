 ...
 *         &lt;element name="ElementLevelInformation" type="{http://www.ups.com/XMLSchema/UXOLT/Common/v1.0}ElementLevelInformationType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DetailType {
    ...
    @XmlElement(name = "Code", namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", required = true)
    protected String code;
    @XmlElement(name = "Description", namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0", required = true)
    protected String description;
    @XmlElement(name = "ElementLevelInformation", namespace = "http://www.ups.com/XMLSchema/UXOLT/Common/v1.0")
